// Auto-seed: same data as seed/index.ts, but doesn't manage DB connection itself.
// Called from index.ts after the DB is already connected.
...
export async function runAutoSeed(): Promise<void> {
  ...
  const categories = await Category.create([
    {
      ...
      image: UNSPLASH.furniture, icon: "Sofa", featured: true, sortOrder: 1,
    ...
    },
    {
      ...
      image: UNSPLASH.lighting, icon: "Lamp", featured: true, sortOrder: 2,
    ...
    },
    {
      ...
      image: UNSPLASH.decor, icon: "Flower", featured: true, sortOrder: 3,
    ...
    },
    {
      ...
      image: UNSPLASH.kitchen, icon: "CookingPot", featured: true, sortOrder: 4,
    ...
    },
    {
      ...
      image: UNSPLASH.bedding, icon: "Bed", featured: true, sortOrder: 5,
    ...
    },
    {
      ...
      image: UNSPLASH.stationery, icon: "PenTool", featured: false, sortOrder: 6,
  ...
  // Coupons
  await Coupon.create([
    { code: "WELCOME10", description: "10% off your first order", discountType: "PERCENTAGE", discountValue: 10, minCartAmount: 50, usageLimit: 1000, perUserLimit: 1, active: true },
    { code: "LUMIERE25", description: "$25 off orders over $200", discountType: "FIXED", discountValue: 25, minCartAmount: 200, usageLimit: 500, perUserLimit: 1, active: true },
    { code: "FREESHIP", description: "15% off (covers shipping on most orders)", discountType: "PERCENTAGE", discountValue: 15, minCartAmount: 100, maxDiscount: 50, usageLimit: 0, perUserLimit: 5, active: true },
    { code: "SEASON20", description: "Seasonal — 20% off everything", discountType: "PERCENTAGE", discountValue: 20, minCartAmount: 0, maxDiscount: 200, usageLimit: 0, perUserLimit: 1, expiresAt: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000), active: true },
  ]);
